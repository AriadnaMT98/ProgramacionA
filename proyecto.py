...
def abrir_admin_ventana():
    ...
    tk.Label(root_usuario, text="Gestión de Usuarios", font=("Broadway",28,), fg="purple", bg="#f0f0f0").pack(pady=20)
    ...
    tk.Button(button_frame, text="Crear", bg="#fadd1e", fg="white", command=añadir_usuarios, **button_config).grid(row=0, column=0, padx=10)
    tk.Button(button_frame, text="Editar", bg="#4caf50", fg="white", command=editar_usuarios, **button_config).grid(row=0, column=1, padx=10)
    tk.Button(button_frame, text="Eliminar", bg="#2196f3", fg="white", command=borrar_usuarios, **button_config).grid(row=0, column=2, padx=10)
    tk.Button(button_frame, text="Salir", bg="#f44336", fg="white", command=regresar_a_login, **button_config).grid(row=0, column=3, padx=10)
